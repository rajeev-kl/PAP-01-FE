    ...
    <div className='mt-8 w-full lg:w-11/12 ml-auto'>
      <div className="flex flex-col lg:flex-row mb-8">
        <div className="lg:w-2/5 lg:mr-6 mb-8 lg:mb-0">
          <img src={process.env.PUBLIC_URL + "/images/image-1.png"} className="w-full rounded-xl" />
        </div>
      ...
      <div className="flex flex-col lg:flex-row mb-8">
        <div className="lg:w-2/5 lg:mr-6 mb-8 lg:mb-0">
          <img src={process.env.PUBLIC_URL + "/images/image-2.png"} className="w-full rounded-xl" />
        </div>
        <div className="text-box lg:w-3/5 mt-0 lg:mt-3">
      ...
      <div className="flex flex-col lg:flex-row">
        <div className="lg:w-2/5 lg:mr-6 mb-8 lg:mb-0">
          <img src={process.env.PUBLIC_URL + "/images/image-3.png"} className="w-full rounded-xl" />
        </div>
        <div className="text-box lg:w-3/5 mt-0 lg:mt-3">
